...
{  
	...
	public static void main(String[] args) throws JsonParseException, JsonMappingException, IOException
	{
		...
		String pathOfTransaction = "/home/admin28/Desktop/FellowshipProgramsJavaSupzz/OOPS/t.json"; 
		 
		
	/*	// reading the company json
		CompanyModel model = new CompanyModel(); //creating the object of the company model class
		ArrayList<Company> companies = new ArrayList<Company>(); //creating the object of Arraylist class of company class.
		ObjectMapper mapper = new ObjectMapper(); //intializing the object of ObjectMapper which is included in jackson librarry.
		
		
		
		model = mapper.readValue(new File("/home/admin28/Desktop/FellowshipProgramsJavaSupzz/OOPS/Company.json"), CompanyModel.class);
											//OR
		model = mapper.readValue(new File("/home/admin28/Desktop/FellowshipProgramsJavaSupzz/OOPS/Company.json"), model.getClass());

		
		companies = model.getCompanyList(); //adding object of model class to the arraylist of company class.
		System.out.println(companies.get(0).getCompanyName()); //displaying out the specific information .
		
		              //OR
		 
		//reading the file using jsonUtil present in our repository.
		System.out.println("Anoyher method is here");
		CompanyModel  model1 = new CompanyModel();
		model1= (CompanyModel) JsonUtil.readValue("/home/admin28/Desktop/FellowshipProgramsJavaSupzz/OOPS/Company.json",model1);;
		System.out.println(companies.get(2).getCompanyName());
		  
		//writing in companyOutput json file.
		Company company = new Company(); //creating the object of the company class
		company.setCompanyId(101);
		company.setCompanyName("rdherrh");
		
		companies.add(company); //adding the object of company class into arraylist class of company class
		
		model.setCompanyList(companies); //setting the object of arraylist class to the model of company model class.
		
		mapper.writeValue(new File("/home/admin28/Desktop/FellowshipProgramsJavaSupzz/OOPS/CompanyOutput.json"), model);
		...
		//companyModel= (CompanyModel) JsonUtil.readMapper("/home/admin28/Desktop/FellowshipProgramsJavaSupzz/OOPS/Company.json", companyModel.getClass());
		companyModel = 	mapper.readValue(new File("/home/admin28/Desktop/FellowshipProgramsJavaSupzz/OOPS/Company.json"), CompanyModel.class /*companyModel.getClass()*/);
				 System.out.println(companyModel.getCompanylist().get(0).getCompanyname());
 	 	 	
		   
		//reading the customer json file with the help of model class object.
		//customerModel =(CustomerModel) JsonUtil.readMapper("/home/admin28/Desktop/FellowshipProgramsJavaSupzz/OOPS/Customer.json", customerModel.getClass());
		customerModel = mapper.readValue(new File("/home/admin28/Desktop/FellowshipProgramsJavaSupzz/OOPS/Customer.json"), CustomerModel.class);
			 	//System.out.println(customerModel.getCustomerList().get(0).getCustomerName()); 
		...
		if(file.length()!=0) 
		{
			...
			//transactionModel=(TransactionModel) JsonUtil.readMapper("/home/admin28/Desktop/FellowshipProgramsJavaSupzz/OOPS/Transaction.json", transactionModel);
